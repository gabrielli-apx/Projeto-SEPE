...
## Anotações:
- decisões sobre cada parte do trabalho
- o que cada integrante ira fazer nos arquivos index

## Responsabilidades de cada integrante:
- Gabrielli Dias: organização dos arquivos css e Inicio de cógigo index;
- João Vitor: Inicio de cógigo index;
- Kauany Luiza Nicolai: posts instagram;
- Kézia Galeno: Figma;
- Rafaela Cunhago: Figma;
- Vitória Bragato Gonçalves: Inicio de cóigigo index.
